package com.ticket.crud.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ticket.crud.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.ticket.crud.model" });
